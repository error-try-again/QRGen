...
export function QRGeneration({
  ...
  const handleSingleResponse = HandleSingleResponse({
    dispatch: dispatch,
    setBatchData: setBatchData,
    setError: setError,
    setQrBatchCount: setQrBatchCount,
  });
  const handleFetchError = HandleFetchError({
    dispatch: dispatch,
    setBatchData: setBatchData,
    setError: setError,
    setQrBatchCount: setQrBatchCount,
  });
  const handleErrorResponse = HandleErrorResponse({
    dispatch: dispatch,
    setBatchData: setBatchData,
    setError: setError,
    setQrBatchCount: setQrBatchCount,
  });
  const handleBatchResponse = HandleBatchResponse({
    dispatch: dispatch,
    setBatchData: setBatchData,
    setError: setError,
    setQrBatchCount: setQrBatchCount,
  ...
  return async () => {
    ...
    try {
      ...
      isBatch
        ...
        : await handleSingleResponse(response);
    } catch (error: unknown) {
