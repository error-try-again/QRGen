...
export enum ErrorType {
    ...
    DUPLICATE_QRCODES = 'Batch request must contain unique QR codes.',
    MAX_LIMIT_EXCEEDED = `Batch request must contain no more than ${MAX_QR_CODES} QR codes.`,
    COULD_NOT_GENERATE_QR = 'Could not generate QR code.',
    COULD_NOT_GENERATE_ARCHIVE = 'Could not generate archive.',
    COULD_NOT_SEND_ARCHIVE = 'Could not send archive.',
